...
void LteApp::handleMessage(cMessage* msg)
{
    if (msg->getKind() == inet::UDP_I_DATA) {
        ...
        processV2XMessage(check_and_cast<SeeThroughMessage*>(msg));
        delete msg;
    } else {
...
void LteApp::sendV2XMessage(SeeThroughMessage* packet)
{
    Enter_Method_Silent();
...
void LteApp::processV2XMessage(SeeThroughMessage* packet)
{
