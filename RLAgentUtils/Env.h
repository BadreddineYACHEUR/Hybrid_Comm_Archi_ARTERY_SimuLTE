...
class Environment
{
    ...
    public:
        ...
        Environment();
        void init();
        std::tuple<double, bool> step(int sender_id, int service_type);
        double reward(int sender_id);
        double reward_2(int sender_id);
        void update_reception_state(int receiver_id, int sender_id, bool is_received, int comm_mode);
        void clear_reception_state(int sender_id);
};
